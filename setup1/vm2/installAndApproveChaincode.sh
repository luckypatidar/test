function exportVariables(){
    ...
    export PEER0_ORG2_CA=${PWD}/crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/peers/peer0.${DOMAIN_OF_ORGANIZATION}/tls/ca.crt
...
setGlobalsForPeer0Org2() {
    ...
    export CORE_PEER_ADDRESS=${HOST_COMPUTER_IP_ADDRESS}:9051
...
setGlobalsForPeer1Org2() {
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG2_CA
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/users/Admin@${DOMAIN_OF_ORGANIZATION}/msp
    export CORE_PEER_ADDRESS=${HOST_COMPUTER_IP_ADDRESS}:10051
...
checkCommitReadyness() {
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
        --peerAddresses ${ORDERER_COMPUTER_IP_ADDRESS}:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
