createCertificateForOrg() {
  ...
  fabric-ca-client enroll -u https://admin:adminpw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/${HOST_COMPUTER_IP_ADDRESS}-8054-ca-${ORGANIZATION_NAME_LOWERCASE}-example-com.pem
  ...
  fabric-ca-client register --caname ca.${DOMAIN_OF_ORGANIZATION} --id.name org2admin --id.secret org2adminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} -M ${PWD}/../crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/peers/peer0.${DOMAIN_OF_ORGANIZATION}/msp --csr.hosts peer0.${DOMAIN_OF_ORGANIZATION} --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} -M ${PWD}/../crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/peers/peer0.${DOMAIN_OF_ORGANIZATION}/tls --enrollment.profile tls --csr.hosts peer0.${DOMAIN_OF_ORGANIZATION} --csr.hosts ${HOST_COMPUTER_IP_ADDRESS} --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} -M ${PWD}/../crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/peers/peer1.${DOMAIN_OF_ORGANIZATION}/msp --csr.hosts peer1.${DOMAIN_OF_ORGANIZATION} --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://user1:user1pw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} -M ${PWD}/../crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/users/User1@${DOMAIN_OF_ORGANIZATION}/msp --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://org2admin:org2adminpw@${HOST_COMPUTER_IP_ADDRESS}:8054 --caname ca.${DOMAIN_OF_ORGANIZATION} -M ${PWD}/../crypto-config/peerOrganizations/${DOMAIN_OF_ORGANIZATION}/users/Admin@${DOMAIN_OF_ORGANIZATION}/msp --tls.certfiles ${PWD}/fabric-ca/${ORGANIZATION_NAME_LOWERCASE}/tls-cert.pem
